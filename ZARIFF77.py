...
#Выведите на экран цены самых дешёвых телефонов из обоих магазинов.
cursor.execute('''select sulpak.price, kivano.price  from sulpak, kivano
                order by   sulpak.price, kivano.price limit 10''')
#Найдите китайские товары из kivano, которые в названии содержат "k"
